...
def materialize_dataset_command(
    ...
    include_audio: bool = typer.Option(False, help="Include and preserve the upstream audio payload for training-ready datasets."),
    batch_size: int = typer.Option(1000, min=1, help="Rows per parquet batch while materializing."),
    max_rows_per_file: int = typer.Option(100_000, min=1, help="Maximum rows to write per parquet or arrow shard file."),
